...
function Channels(props) {
  ...
  const getChannelInfo = () => {
    localStorage.setItem("selectedChannel", JSON.stringify(props.streamInfo));
  };

  return (
    <Box onClick={getChannelInfo} className={classes.container}>
      <Link to={`/${props.streamInfo.name}`}>
        <FiCard
        ...
        >
          <FiCardActionArea>
            <FiCardContent
              ...
              sx={{
                backgroundImage: `url(${
                  props.streamInfo.logo ? props.streamInfo.logo : noLogo
                })`,
              }}
            ></FiCardContent>
          </FiCardActionArea>
